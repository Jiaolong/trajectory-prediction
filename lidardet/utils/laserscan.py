...
class LaserScan:
    ...
    def __init__(self, cfg):
        ...
        self.project = cfg.get('project', True)
        self.proj_H = cfg.sensor.range_image.height
        self.proj_W = cfg.sensor.range_image.width
        self.proj_fov_up = cfg.sensor.fov_up 
        self.proj_fov_down = cfg.sensor.fov_down
    ...
    def open_scan(self, filename):
        ...
        scan = np.fromfile(str(filename), dtype=np.float32)
    ...
    def do_range_projection(self):
        ...
        coords = np.vstack([proj_y, proj_x])
...
class SemLaserScan(LaserScan):
    ...
    def __init__(self, cfg): 
        super(SemLaserScan, self).__init__(cfg=cfg)

        sem_color_dict = cfg.get('color_map', None)
        max_classes = cfg.get('max_classes', 300)
    ...
    def open_label(self, filename):
        ...
        label = np.fromfile(str(filename), dtype=np.int32)
