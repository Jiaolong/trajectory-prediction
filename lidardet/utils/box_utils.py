...
def boxes_to_corners_3d(boxes3d):
    ...
    Returns:
    """
    boxes3d, is_numpy = common.check_numpy_to_torch(boxes3d)
    ...
    corners3d = geometry.rotate_points_along_z(corners3d.view(-1, 8, 3), boxes3d[:, 6]).view(-1, 8, 3)
...
def remove_points_in_boxes3d(points, boxes3d):
    ...
    """
    boxes3d, is_numpy = common.check_numpy_to_torch(boxes3d)
    points, is_numpy = common.check_numpy_to_torch(points)
...
def boxes3d_lidar_to_aligned_bev_boxes(boxes3d):
    ...
    """
    rot_angle = geometry.limit_period(boxes3d[:, 6], offset=0.5, period=np.pi).abs()
